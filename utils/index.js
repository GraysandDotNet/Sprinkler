...
//	require all js files in the given dir, passing them the given param
exports.requireAll = function requireAll( dirName, args )
{
	var fs = require( 'fs' ); 
	...
	fs.readdirSync( dirName ).forEach(
		function( fileName )
		{
			...
			{
				require( path.join( dirName, fileName ) )( args );
			}
		}
	);
}
